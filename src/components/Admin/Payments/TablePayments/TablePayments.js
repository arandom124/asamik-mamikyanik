      ...
      <Table className="table-payments-admin">
        ...
        <Table.Body>
          {map(payments, (payment, index) => (
            <Table.Row key={index}>
              <Table.Cell
              className="text-sky-400 font-bold">{payment.id}</Table.Cell>
              <Table.Cell
              className="text-amber-300">{payment.table_data.number}</Table.Cell>
              <Table.Cell
              className="text-orange-400">{payment.totalPayment}$</Table.Cell>
              <Table.Cell>
                <Icon 
