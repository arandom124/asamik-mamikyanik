        ...
        <Table className='table-users-admin'>
            ...
            <Table.Body>
                {map(users, (user, index) => (
                    <Table.Row key={index}>
                        <Table.Cell
                        className='text-orange-400'>{user.username}</Table.Cell>
                        <Table.Cell
                        className='text-orange-400'>{user.email}</Table.Cell>
                        <Table.Cell
                        className='text-orange-400'>{user.first_name}</Table.Cell>
                        <Table.Cell
                        className='text-orange-400'>{user.last_name}</Table.Cell>
